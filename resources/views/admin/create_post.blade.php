        ...
        <div class="container">
            ...
            <form action="{{ route('savePost') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" placeholder="Title of the post" require>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" rows="6" class="form-control" placeholder="The Body of the Post" name="description"></textarea>
                </div>
